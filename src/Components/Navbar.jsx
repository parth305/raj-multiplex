...
const Navbar = () => {
	...
	const notselectedpage =
		"block py-2 pr-4 pl-3 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
	...
	return (
		<nav className="border-gray-200 px-2 sm:px-4 py-4 sm:py-2.5 rounded-b bg-gray-900 fixed top-0 left-0 w-full">
			<div className="container flex flex-wrap justify-between items-center mx-auto w-full">
				...
				<div className="flex md:order-2">
					...
					<div className={`hidden relative md:block w-96`}>
						...
						<input
							...
							className="block p-2 pl-10 w-full rounded-lg bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
							placeholder="Search..."
						/>
					</div>
					<button
				...
				<div
					...
					<ul className="flex flex-col sm:items-center p-4 mt-4 mdd:large bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-gray-900 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
						<li>
							<a
								href="#"
								className={
									location.pathname === "/" ? selectedpage : notselectedpage
								}
								aria-current="page">
								Home
							</a>
						...
						{login ? (
							<>
								...
								<li>
									<a
										href="#"
										className={
											location.pathname === "/Cacelbooking"
												? selectedpage
												: notselectedpage
										}>
										Cancel Booking
							...
							<>
								<li>
									<Link
										to="/Login"
										className="block py-2 pr-4 pl-3 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
										Sign in
									</Link>
								</li>
								{/* <li>
